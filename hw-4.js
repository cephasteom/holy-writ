...
kick.set({inst: 1, bank: 'kick.808', cut: [kick.i, bass.i, noise.i, noise2.i, breaks.i],cutr:ms(0.5),vol:1.75})
kick.p.n.set(bassp).sub(31).mod(12).add(60)
kick.p.i.set(kick.x).mul(16).step(1)
kick.e.or('1|0|*3')

sn.set({inst: 1, bank:'claps.rare', i: 3, fx0:0.125, vol:1.5,
  cut: [0,1,2,3,4,5,6]
})
...
breaks.set({cut: [breaks.i,bass.i,hh.i], bank: 'breaks.hp', lc:0.3, dur:ms(4), acurve:0.75, vol:1.5, hc:0.3})
breaks.p.a.set(kick.e).if(1,0).btms()
breaks.p._pan.set(breaks.y).mtr(0.9,0.3)
